...
module atlasDatabase 'atlas_database_existing.bicep' = {
  name: 'atlasDatabase'
  params: {
//    location: location
    suffix: suffix
...
module ohdsiWebApiWebapp 'ohdsi_webapi_failed.bicep' = {
  ...
  params: {
    ...
    keyVaultName: keyVault.name
    acrName: acrName
//    jdbcConnectionStringWebapiAdmin: 'jdbc:postgresql://${atlasDatabase.outputs.postgresServerFullyQualifiedDomainName}:5432/${atlasDatabase.outputs.postgresWebApiDatabaseName}?user=${atlasDatabase.outputs.postgresWebapiAdminUsername}&password=${keyVault.getSecret('ohdsi-admin-password')}&sslmode=require'
    postgresWebapiAdminSecret: keyVault.getSecret('ohdsi-admin-password')
    postgresWebapiAppSecret: keyVault.getSecret('ohdsi-app-password')
    ...
    //postgresServerFullyQualifiedDomainName: atlasDatabase.outputs.postgresServerFullyQualifiedDomainName
    //postgresWebApiDatabaseName: atlasDatabase.outputs.postgresWebApiDatabaseName
    }
  dependsOn: [
    atlasDatabase
  ]
...
module atlasUI 'ohdsi_atlas_ui.bicep' = {
  ...
  params: {
    ...
    suffix: suffix
    appServicePlanId: appServicePlan.id
    ohdsiWebApiUrl: 'https://app-ohdsiwebapi-jw20231012.azurewebsites.net/WebAPI/'
    logAnalyticsWorkspaceId: logAnalyticsWorkspace.id
    subnetID: '/subscriptions/7f83d432-bf4a-4d15-b972-4871bd8b9225/resourceGroups/RG-DW_VNET-EastUS2/providers/Microsoft.Network/virtualNetworks/DW_VNET-EastUS2/subnets/snet-jw20231012-webapp'
  }
/*  dependsOn: [
